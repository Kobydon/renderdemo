    ...
    try:
        ...
        def prepare_cart_item(item):
            ...
            prepared_item = {
                ...
                "is_checked_digital_printing": str(
                    item.get(
        ...
        try:
            ...
            for item in cart_items:
                ...
                prepared = prepare_cart_item(item)

                incoming_items.append(prepared)
