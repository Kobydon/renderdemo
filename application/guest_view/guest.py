...
def hold_and_pay():
    ...
    try:
        ...
        # DISCOUNT
        # ==========================================================
        # Discount is an order-level percentage.  Item prices and
        ...
        if existing_hold:
            ...
            # ======================================================
            # APPLY DISCOUNT TO UPDATED HELD ORDER
            # ======================================================

            discount_amount = round(
                (new_total * discount) / 100,
                2
            )
        ...
        # ==========================================================
            ...
            # The calculated subtotal is before discount.
            # Store/use the discounted total for the new order.
            new_total = total
