...
class HeldCart(db.Model):
    ...
    working_on_label = db.Column(db.String(200),default='not_started')
    working_on_id_label = db.Column(db.String(200))
    working_on_large_format = db.Column(db.String(200),default='not_started')
    working_on_id_large_format = db.Column(db.String(200))
    working_on_dtf = db.Column(db.String(200),default='not_started')
    working_on_id_dtf = db.Column(db.String(200))
    working_on_digital_printing = db.Column(db.String(200),default='not_started')
    working_on_id_digital_printing = db.Column(db.String(200))
    # dtf_confirm = db.Column(db.String(200))
    ...
    working_on= db.Column(db.String(200),default='not_started')  # not_started, in_progress, completed  c
